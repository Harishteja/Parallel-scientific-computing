...
implicit none
    ...
    ! Input parameters
    integer ::threads,itr,t1,t2,nz, nx, ny, nt,i,j,k
    real ::L, dt, alpha,time,dx,dy,dz,k1,k2,k3
...
do i=1,nx
   ...
   write(*,*) (T(i,j,2),j=1,ny)
   
end do
OPEN(UNIT=100, FILE="time_3dp_1.dat", STATUS="REPLACE", ACTION="WRITE")
WRITE(100,*) t2-t1
   !      do i = 1,nx
  !             WRITE(100,*) x(i)
 !        end do
...
OPEN(UNIT=100, FILE="temperature_3d_1_1.dat", STATUS="REPLACE", ACTION="WRITE")
 
             do i = 1,nx
                 WRITE(100,*) (T(i,32,k),k=1,nz)
             end do
